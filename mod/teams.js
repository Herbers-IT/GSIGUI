...
exports.updateTeam = (req, res) => {
    ...
    function removeLogoFile(err, teamList){
        ...
        db.update({ _id: teamId }, { $set: {team_name: team.team_name, short_name:team.short_name, country_code:team.country_code, logo:team.logo, room:team.room, tsChannelName:team.ts_name}}, {}, (err, numReplaced) => {
            if(err) return res.sendStatus(500);
